...
const reviews = [
    {
        name: 'Елена Иванова',
        rating: 5,
        text: 'Сара создала самый красивый свадебный торт для нашего особенного дня! Он был не только потрясающе красивым, но и невероятно вкусным. Все гости спрашивали рецепт!',
    ...
    },
    {
        name: 'Михаил Петров',
        rating: 5,
        text: 'Торт на 5-летие моей дочери был идеальным! Сара воплотила именно то, что мы представляли — торт-замок принцессы, который осуществил мечты нашей малышки.',
    ...
    },
    {
        ...
        rating: 5,
        text: 'Потрясающий торт на годовщину! Сара работала с нами, чтобы создать что-то действительно особенное. Внимание к деталям и вкусовые сочетания были выдающимися.',
